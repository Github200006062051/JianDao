...
import com.example.jiandaoapp.Base.BaseApp;
import com.example.jiandaoapp.net.api.NetApi;
...
public class RetrofitUtils implements INetWork{
    ...
    private RetrofitUtils(){
        File cache = new File(BaseApp.baseApp.getCacheDir(), "cache");
        Cache max = new Cache(cache, 1024 * 1024 * 10);
...
//                            清楚头信息，如果服务器不知粗--看网络请求返回结果
    ...
    private  boolean isNetWorkValid(){
        ...
        ConnectivityManager manager = (ConnectivityManager)BaseApp.baseApp.getApplicationContext()
